...
for each function, the following API is specified:
  ...
  it is permissible to omit parameters for calls to color_blank and
  color_random only */

// no colorization
const color_blank = (cell, colorspace) => [];

// dummy colorization: just to test if the cells shade properly
const color_random = (cell, colorspace) => {
...
/* auxiliary function returns an array of colors from a pretty gradient with
